function plot_selected_components(save_dir, subject_id, scan_freqs, searchTopos, ...
...
annotation(figSel, 'textbox', [0.010 0.09 0.040 0.34], ...
    ...
    'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'FontWeight', 'bold', 'FontSize', 14, 'Rotation', 90, 'FitBoxToText', 'off');
sgtitle(sprintf('Selected and Rejected Components: %s', subject_id), ...
    'FontSize', 14, 'FontWeight', 'bold');
drawnow;
pause(0.05);
save_figure_png(figSel, fullfile(save_dir, sprintf('GCP_eeg_GED_subj%s_component_selection.png', subject_id)));
close(figSel);
