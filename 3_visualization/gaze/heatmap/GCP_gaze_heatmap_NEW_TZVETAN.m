...
design = zeros(2,2*numSubs);
for i = 1:numSubs
    design(1,i) = i;
end
for i = 1:numSubs
    design(1,numSubs+i) = i;
end
design(2,1:numSubs)        = 1;
design(2,numSubs+1:2*numSubs) = 2;
...
% extract single subject values from mask
