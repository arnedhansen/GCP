...
exportgraphics(gcf, fullfile(figpath, 'GCP_gaze_microsaccades_rate.png'), 'Resolution', 600);
...
exportgraphics(gcf, fullfile(figpath, 'GCP_gaze_microsaccades_combined.png'), 'Resolution', 600);
