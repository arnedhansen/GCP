...
runSESOI <- function() {
  ...
  ## TEMPORARY: SESOI and DGP slope = 0.1 (revert using commented pilot line below).
  sesoi_beta <- 0.10
  # true_beta <- 0.247639934007685 ## pilot contrast_num_c (PeakFrequency)
  pilot_true_beta_contrast_num_c <- 0.247639934007685 ## pilot reference (plot label)
  true_beta <- 0.10
  ...
  plot_title <- sprintf(
    "SESOI linear power (SESOI=%s; true(DGP)=%s; pilot c=%s)",
